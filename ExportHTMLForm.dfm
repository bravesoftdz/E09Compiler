object frmExportHTMLWizard: TfrmExportHTMLWizard
  ...
  Width = 699
  Height = 505
  Caption = 'Βοηθός για την δημιουργία ιστοσελίδας'
  Color = clBtnFace
  ...
  object Label2: TLabel
    ...
    Width = 139
    Height = 13
    Caption = 'Πάχος περιγράμματος πίνακα'
  end
  ...
  object cmbFontFace: TComboBox
    ...
    Width = 145
    Height = 21
    Hint = 'Αντιστοιχεί στο <FONT FACE="γραμματοσειρά">'
    ItemHeight = 13
  ...
  object txtFontSize: TEdit
    ...
    Width = 49
    Height = 21
    Hint = 'Αντιστοιχεί στο <FONT SIZE="γραμματοσειρά">'
    ParentShowHint = False
    ShowHint = True
    TabOrder = 4
    Text = '-1'
  ...
  object txtBorder: TEdit
    ...
    Width = 41
    Height = 21
    Hint = 'Αντιστοιχεί στο <TABLE BORDER="πάχος">'
    ParentShowHint = False
    ShowHint = True
    TabOrder = 5
    Text = '0'
